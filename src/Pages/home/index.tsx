        ...
        <>
         ...
         <Grid2 size={{xs: 4, sm: 4, md: 8}}>
            ...
            <Grid2  size={{xs: 4, sm: 4, md: 4 }} sx={{p: 2}} >
                ...
                <Button href='#/math' sx={{width: 435, height: 100, fontSize: '1.5em', color: 'white'}} variant='contained' color='success'>
                     <CalculateIcon sx={{fontSize:"4em", color: '#B197FC'}} />Math 
                </Button>
                <Button href='#/reading' sx={{width: 435, height: 100, fontSize: '1.5em', color: 'white'}} variant='contained' color='success'>
                   <AutoStoriesIcon sx={{fontSize:"4em", color: '#B197FC', p: 2}} />Reading
                </Button>
                <Button href='#/writing' sx={{width: 435, height: 100, fontSize: '1.5em', color: 'white'}} variant='contained' color='success'>
