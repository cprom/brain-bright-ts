...
type divisionObject = {
  ...
  function divisionProblems(divisor: number) {
  
  const divisionArray: divisionObject[] = [];
  ...
  return divisionArray;
    ...
    const handleInputChange = (id: number, event: React.ChangeEvent<any>) => {
      ...
      const chooseLevel = ( event: React.ChangeEvent<any>) => {
        ...
        const newProblems = divisionProblems(event.target.value)
                        ...
                        <Paper key={problem.id} elevation={5} sx={{p: 2, m: 2}}>
                            <Grid2 container spacing={2} display="flex" justifyContent="center" alignItems="center" textAlign='center' size="grow">
                                ...
                                <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center'}}>
                                    ...
                                    <Stack><Typography fontSize={30}>{problem.dividen}</Typography></Stack>                                 
                                    <Stack><Typography fontSize={30} >÷ {problem.divisor}</Typography> </Stack>   
                                    </div>
                                </div> 
                                <TextField 
...
const DivisionTableProblemSets = () => {
    return (
...
export default DivisionTableProblemSets